***********************
LimeSDR Mini v2.4 Board
***********************

Introduction
============

LimeSDR Mini v2.4 Board Key Features
------------------------------------
...
.. figure:: images/LimeSDR-Mini_v2.4_3D_top.png
  :width: 600
  
  Figure 1: LimeSDR Mini v2.4 board top view


.. figure:: images/LimeSDR-Mini_v2.4_3D_bot.png
  :width: 600
  
  Figure 2: LimeSDR Mini v2.4 board bottom view
...
.. figure:: images/LimeSDR-Mini_v2.4_diagrams_r0_block.png
  :width: 600
  
  Figure 3: LimeSDR Mini v2.4 Development Board Block Diagram
  
This section contains component location description on the board. LimeSDR-Mini board picture with highlighted connectors and main components is presented in Figure 4 and Figure 5.
...
.. figure:: images/LimeSDR-Mini_v2.4_diagrams_r0_RF.png
  :width: 600
...
.. figure:: images/LimeSDR-Mini_v2.4_components_LEDs.png
  ...
  Figure 7: LimeSDR Mini v2.4 indication LEDs (top and bottom)
...
To debug FPGA design, flash bitstream to FPGA and/or Flash memory JTAG is used. It is located on the PCB top side (see :ref:`target4`) and attaches to the programmer using 7-pin, 0.1” spaced JTAG connector J5. JTAG connector pins, schematic signal names, FPGA interconnections and I/O standards are listed in Table 12.
...
.. figure:: images/LimeSDR-Mini_v2.4_diagrams_r0_clock.png
  :width: 600
  
  Figure 9: LimeSDR Mini v2.4 board clock distribution block diagram
...
.. table:: Table 14. LimeSDR Mini v2.4 main clock lines
...
.. figure:: images/LimeSDR-Mini_v2.4_diagrams_r0_power.png
  :width: 600
  
  Figure 12: LimeSDR Mini v2.4 board power distribution block diagram
